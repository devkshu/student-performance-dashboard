...
(()=>{
    const e = new Error("Cannot find module '../data/persona_profiles.json'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
"use client";
...
function Page() {
    ...
    const personaData = Array.isArray(personaProfiles) ? personaProfiles : [];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0544af7._.js.map