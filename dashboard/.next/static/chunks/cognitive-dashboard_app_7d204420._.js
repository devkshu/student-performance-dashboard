...
function StudentTable(param) {
    let { students } = param;
    _s();
    const [query, setQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$cognitive$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    if (!students || students.length === 0) return null;
...
_s(StudentTable, "HYX2QbDDdTtlu7GfoQbAPZOIM6k=");
_c = StudentTable;
var _c;
...
//# sourceMappingURL=cognitive-dashboard_app_7d204420._.js.map